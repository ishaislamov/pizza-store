...
const onClosePopup = (obj:sortItem) => {
  dispatch(setSort(obj))
  setIsVisible(false)
}

// скрывает sort при клике на другую область (body)
React.useEffect(() => {
  ...
  return () => {
    console.log('useEffect doesn`t render')
  ...
  return (
      ...
      </div>
      {
        ...
        {categories.map((obj, id) =>
         (<li key={id} onClick={() => onClosePopup(obj)}
